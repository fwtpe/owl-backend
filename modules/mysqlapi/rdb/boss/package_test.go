...
var _ = BeforeSuite(func() {
	DbFacade = ginkgoDb.InitDbFacadeByFlag(tFlag.OWL_DB_BOSS)
})
...
var (
	itSkipMessage = tFlag.OwlDbHelpString(tFlag.OWL_DB_BOSS)
	itSkip        = tFlag.BuildSkipFactoryOfOwlDb(tFlag.OWL_DB_BOSS, itSkipMessage)
)
